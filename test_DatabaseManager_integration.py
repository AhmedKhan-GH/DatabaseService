    ...
    def test_database_operations(self):
        ...
        with SQLiteDatabase(self.db_file) as connection:
            with DatabaseManager(connection) as db_manager:
                ...
                # Insert a record
                row_id = db_manager.create_record("test", {"name": "Integration Test"})

                # Retrieve the inserted record
                retrieved_record = db_manager.retrieve_record("test", row_id)
                ...
                # Update the record
                db_manager.update_record("test", row_id, {"name": "Updated Test"})

                # Retrieve the updated record
                updated_record = db_manager.retrieve_record("test", row_id)
                ...
                # Delete the record
                db_manager.delete_record("test", row_id)

                # Attempt to retrieve the deleted record
                deleted_record = db_manager.retrieve_record("test", row_id)
